...
exports.run = async (client, message, args) => {
    if(!message.member.hasPermission("ADMINISTRATOR") && !message.member.hasPermission("MANAGE_GUILD")) return message.reply(":x: Bu Komutu Kullana Bilmek İçin **__Sunucuyu Yönet/MANAGE_GUILD__** Yetkisine Sahip Olmalısın Dostum!");
